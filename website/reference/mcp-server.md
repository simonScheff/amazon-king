...
every tool call over HTTP is written to the [audit log](../guide/operations).
Mutations drafted over either transport also record domain audit events. Tokens
...
| `set_campaign_placement_multiplier` | Drafts placement bid multipliers (Top of Search %, Product Pages %). |
