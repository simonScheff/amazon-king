import { acos, estimatedAdProfit } from "../calc.js";
...
export const PLACEMENT_OPPORTUNITY_RULE_VERSION = "placement_opportunity@1";
...
/**
 * placement_opportunity@1 — a placement is consistently profitable with
 ...
 * cannot compound beyond the cap in one recommendation.
 */
